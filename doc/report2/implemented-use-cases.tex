...
\write18{ if [ ! -f Y8ZJyr3.png ] ; then wget https://i.imgur.com/Y8ZJyr3.png ; fi ; }
\begin{figure}[H]
    \centering
...
\write18{ if [ ! -f Njimj9n.png ] ; then wget https://i.imgur.com/Njimj9n.png ; fi ; }
\begin{figure}[H]
    \centering
...
\write18{ if [ ! -f OdwmfwK.png ] ; then wget https://i.imgur.com/OdwmfwK.png ; fi ; }
\write18{ if [ ! -f YTZbVeR.png ] ; then wget https://i.imgur.com/YTZbVeR.png ; fi ; }
\begin{figure}[h]
    \centering
