...
Even though the Floyd-Warshall's algorithm functions correctly with negative weight edges, this feature will most likely not be of much use, due to the nature of the problem:
