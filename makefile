...
O_FILES=$(ODIR)/Astar.o $(ODIR)/coord.o $(ODIR)/DFS.o $(ODIR)/Dijkstra.o $(ODIR)/FloydWarshall.o $(ODIR)/DUGraph.o $(ODIR)/DWGraph.o $(ODIR)/Kosaraju.o $(ODIR)/KosarajuV.o $(ODIR)/MapGraph.o $(ODIR)/MapViewer.o $(ODIR)/SCCnode.o $(ODIR)/ShortestPath.o $(ODIR)/ShortestPathAll.o $(ODIR)/ShortestPathOneMany.o
